...
const ReturnPage = () => {
    return (
        <>
        <Navbar />
       <div className="returns-refunds-box">
       <div className="pic-in-return">
        <h1 className="headline-in-return">Returns & Refunds</h1>
        </div>
...
<section className="section-with-healines-and-text">
<h2>our guarantee</h2>
<p>All items excluding ex-display and secondhand goods are covered by at least 12 months warranty; this is detailed on your receipt. Any secondhand or ex-display product is covered by at least 3 months warranty as noted in the original listing.
...
<section className="section-with-healines-and-text">
<h2>returns process/your statutory right</h2>
<p>If you wish to return goods purchased online or over the phone, you should notify Hi-Fi Corner of your intention to do so within 14 days of the date of receipt.
...
<section className="section-with-healines-and-text">
<h2>refunds</h2>
<p>Once your returned item is received and inspected, we will send you an email or phone call to notify you that we have received your returned item.We will also notify you of the approval or rejection of your refund.
...
<section className="section-with-healines-and-text">
<h2>exchanges</h2>
<p>We can only replace items if they are defective or damaged. If you need to exchange the product for the same item due to a fault, please first send us an email at sales@hificorner.co.uk and once approved, send your item to:

Hi-Fi Corner, 2 Joppa Road, Mackenzie House, Portobello, Edinburgh, EH15 2EU.

Please also include the proof of purchase and a cover letter detailing the reason for exchange.</p>
</section>
...
If you are shipping an item over £100, we would advise using a trackable shipping service or purchasing shipping insurance. We cannot guarantee that we will receive your returned item.</p>
</section>
