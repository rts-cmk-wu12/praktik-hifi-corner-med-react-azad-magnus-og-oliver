    ...
    return (
        ...
        <section className="brand__container">
            <article className="brand__top">
                ...
                <div>
                    <img className="brand__logo" src="brandsbilleder/hificorner-logo.png" alt="HiFi Corner Logo" />
                </div>
            </article>
                ...
                <div className="brand__section-flex">
                    <section className="brand__subsection">
                        <article className="brand__logos">
                            ...
                            <img src="brandsbilleder/brands.png" alt="Brand logos" />
                        </article>
                    </section>
                    <article className="brand__content">
                        <section className="brand__text">
                            ...
                            <div>
                                ...
                                <a className="brand__link" href="shop.html">VISIT OUR SHOP TO FIND MORE BRANDS </a>
                            </div>
                        </section>
                    </article>
                </div>
